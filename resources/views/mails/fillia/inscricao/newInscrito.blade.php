...
.section-footer-e .item{text-align: center;}
    ...
    <div class="section">
      <div class="section-content">
          ...
          <div class="section-middle">
              <h2 style="padding-top:8px;padding-bottom: -10px;" class="title">Ficha De Inscrição</h2>
          ...
          <div class="section-footer">
              <div class="section-footer-e">
                <div class="item">
                    <p><span>NIF: </span>963861984L2</p>
                </div>
                <div class="item">
                    <p>Assinatura Direictor(a)</p>
                    <hr>
                    <p>{{$msg['mycollege']->direictor}}</p>
                </div>
              </div>
          </div>
      </div>
